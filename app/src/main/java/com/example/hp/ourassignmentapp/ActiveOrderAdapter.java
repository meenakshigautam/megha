...
public class ActiveOrderAdapter extends RecyclerView.Adapter<ActiveOrderAdapter.MyViewHolder>
    ...
    public ActiveOrderAdapter(Context context, List<OrderHistoryModel> orderHistories)
    {
    ...
    @Override
    public void onBindViewHolder(final ActiveOrderAdapter.MyViewHolder holder, int position)
    {
       ...
       /* holder.acceptedbtn.setOnClickListener(new View.OnClickListener()
        ...
        holder.acceptedbtn.setOnClickListener(
                new View.OnClickListener()
                {
                    ...
                    public void onClick(View view) {
                        ...
                        if (holder.acceptedbtn.getText().toString().equalsIgnoreCase("Accept Order"))
                        ...
                        else if(holder.acceptedbtn.getText().toString().equalsIgnoreCase("Arrived Store"))
                        {
                        ...
                        else if(holder.acceptedbtn.getText().toString().equalsIgnoreCase("Start Delivery"))
                        {
                        ...
                        else if(holder.acceptedbtn.getText().toString().equalsIgnoreCase("Drop Order"))
                        {
                        ...
                        else if(holder.acceptedbtn.getText().toString().equalsIgnoreCase("Close Order"))
                        {
        ...
        private void hitApiFifth(final MyViewHolder holder)
        {
                    ...
                    new Response.Listener<String>()
                    {
                        ...
                        public void onResponse(String response)
                        {
                            try
                            {
                                ...
                                //holder.acceptedbtn.setText("Close Order");
        ...
        private void hitApiForth(final MyViewHolder holder)
        {
            RequestQueue queue = Volley.newRequestQueue(context);
            //String url ="http://www.google.com";
        ...
        private void hitApiThird(final MyViewHolder holder)
        {
            RequestQueue queue = Volley.newRequestQueue(context);
            //String url ="http://www.google.com";
                    ...
                    new Response.Listener<String>()
                    {
                        ...
                        public void onResponse(String response)
                        {
                            try
                            {
                                ...
                                holder.acceptedbtn.setText("Drop Order");
        ...
        private void hitApiSecond(final MyViewHolder holder)
                  {
                      RequestQueue queue = Volley.newRequestQueue(context);
                      //String url ="http://www.google.com";
                              ...
                              new Response.Listener<String>()
                              {
                                  ...
                                  public void onResponse(String response)
                                  {
                                      try
                                      {
                                          ...
                                          holder.acceptedbtn.setText("Start Delivery");
    ...
    private void hitApi(final MyViewHolder holder)
                ...
                new Response.Listener<String>()
                {
                    ...
                    public void onResponse(String response)
                    {
                        try
                        {
                            ...
                            holder.acceptedbtn.setText("Arrived store");
