...
public class UpcomingOrdersFragment extends Fragment
    {
        ...
        private static final String TAG = "UpcomingOrders";

        RecyclerView recyclerView;

        String DATA_URL = "http://52.70.180.154/api/auth/upcomingorders";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
       {
        ...
        upcomingorderadapter = new UpcomingOrderAdapter(getActivity(), orderHistories);
