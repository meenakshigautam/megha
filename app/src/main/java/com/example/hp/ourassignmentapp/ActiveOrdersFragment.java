...
public class ActiveOrdersFragment extends Fragment
         ...
         private static final String TAG = "ActiveOrders";

         RecyclerView recyclerView;

         String DATA_URL = "http://52.70.180.154/api/auth/activeorders";

         private static final int MY_SOCKET_TIMEOUT_MS = 50000;

         public List<OrderHistoryModel> orderHistories;

         private ActiveOrderAdapter mAdapter;
...

         {
             ...
             mAdapter = new  ActiveOrderAdapter(getActivity(), orderHistories);
                     ...
                     new Response.Listener<String>()
                     {
                         ...
                         public void onResponse(String response)
                         {
                             ...
                             try
                             {
                                 ...
                                 Log.d("activeorderresponse",response.toString());
                                 ...
                                 for (int i = 0; i < jsonarray1.length(); i++)
                                     ...
                                     //orderhistorymodel.setVendorId(object.getString("id"));
                                     ...
                                     orderhistorymodel.setOrderId(orderid);
                                      ...
                                      //orderhistorymodel.setVendorNo(object.getString("number"));
